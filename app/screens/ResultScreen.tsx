...
export default function ResultScreen() {
  ...
  const { imageUrl, filterName } = route.params as { imageUrl: string; filterName: string };
  ...
  const saveToGallery = async () => {
    try {
      ...
      if (status !== 'granted') {
        Alert.alert('Permission Denied', 'Need permission to save images to your gallery.');
        return;
      }
